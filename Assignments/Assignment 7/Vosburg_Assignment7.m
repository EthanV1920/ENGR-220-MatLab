...
legend(problem3bFig, "Original Data", "Line of Best Fit e^{5.8750}*e^{-0.8452x}");
...
title(problem4fig, "Problem 4 Best Fit Plot");
legend(problem4fig, "Original Data", "Line of Best Fit e^{4.9548}*e^{-0.0160x}");
